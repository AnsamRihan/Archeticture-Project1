...
DecompReadBuffer: .space 262144
successfulD: .asciiz "\nThe file successfuly Decompressed!!\n"
HexArray: .space 65536
hexNumber: .space 8
BufferForNumber: .space 9
#FOR DICTIONARY----------------------------------------------
readyDictionary: .asciiz "Your dictionary is ready to use!\n"
wordArray: .space 262144 #512*32 2D array
dictionary: .space 262144 #512*32 2D array
savedWord: .space 32
...
dictReadBuffer: .space 262144
dictionary_txt: .asciiz "C:/Users/ansam/Desktop/dictionary.txt"
...
main:
	...
	getPathDict:
		...
		# Read from the file
    		...
    		li $a2, 262144           # Maximum number of bytes to read
			...
			li $t3, 32  
		   	insertion55:
				...
				addiu $t1, $t1, 1  # Increment the buffer address by 1 byte		
        			...
        			bnez $t3, insertion55 # Repeat the loop until the buffer is filled	
